...
class SharesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'supervisor_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'created' => '2020-01-29 04:47:37',
                'modified' => '2020-01-29 04:47:37',
                'supervisor_id' => 1,
                'manager_id' => 1,
                'category_id' => 1
            ],
