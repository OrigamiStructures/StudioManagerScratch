...
class SubscriptionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'range_flag' => ['type' => 'integer', 'length' => 4, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'created' => '2015-12-10 21:31:48',
            'modified' => '2015-12-10 21:31:48',
            'user_id' => 1,
