...
class ArtistsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'member_user_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'member_id' => 1,
                'user_id' => '7987bd6e-5add-4830-afc9-c5a6cf768103',
                'member_user_id' => 1
            ],
        ];
        parent::init();
