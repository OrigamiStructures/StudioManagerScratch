...
class ManifestsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'member_id' => [
			...
			'null' => false,
			'default' => null,
			'comment' => 'id of Member record that is an artist',
			'precision' => null,
			'autoIncrement' => null
		],
        'user_id' => [
			...
			'null' => false,
			'default' => '',
			'comment' => 'id of the registered user that controls this \'access/rights\' record',
			'precision' => null
		],
        'manager_id' => [
            'type' => 'uuid',
        ...
        'publish_manager' => [
			...
			'null' => false,
			'default' => '0',
			'comment' => 'whether other managers can see this manager',
			'precision' => null
		],
        'publish_manager_contact' => [
			'type' => 'boolean',
			'length' => null,
			'null' => false,
			'default' => '0',
			'comment' => 'when published, include primary contact/address visibility',
			'precision' => null
		],
        '_constraints' => [
