 ...
 * Permissions Model
 *
 * @property \App\Model\Table\LayersTable|\Cake\ORM\Association\BelongsTo $Layers
 * @property \App\Model\Table\UsersTable|\Cake\ORM\Association\BelongsTo $Users
 * @property \App\Model\Table\ManifestsTable|\Cake\ORM\Association\BelongsTo $Manifests
 *
...
class PermissionsTable extends AppTable
{
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['manifest_id'], 'Manifests'));
